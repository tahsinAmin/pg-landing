            ...
            <div className="main-content w-11/12 mx-auto py-8">
              ...
              <div className="content-1 grid grid-cols-3 gap-3 ">
                ...
                <div className="relative">
                  ...
                  <h1 className='absolute -top-14 z-50 text-9xl tracking-tighter text-red-500 font-bold left-6'>13</h1>
                    ...
                    <div className="flex flex-row-reverse">
                      <div>
                        ...
                        <div className="game-card bg-white rounded-md p-3">
                          ...
                          <div className="highlights mt-4 flex space-x-3 overflow-scroll scrollbar-hide">
                            
                            <div className="h-card relative h-[150px] w-[200px] rounded-xl cursor-pointer hover:scale-105 transform transition duration-300 ease-out " >
                              <Image
                                src='/img/2.jpg' 
                                layout='fill' 
                                objectFit='cover'
                                className=''
                              /> 
                              <div className="h-card-over absolute h-full w-full bg-black bg-opacity-50">
                            ...
                            <div className="h-card h-[150px] w-[200px] rounded-xl cursor-pointer hover:scale-105 transform transition duration-300 ease-out" >
                              <Image
                                src='/img/1.jpg' 
                                layout='fill' 
                                objectFit='cover'
              ...
              <div className="content-2  relative left-8 bg-gray-300 py-2 px-8 min-h-[38vh]">
                ...
                <div className="points absolute w-4/7 bottom-8 transform translate-x-80 pl-28 grid grid-cols-3 gap-x-7 z-50">
                  <div className="points-card rounded-lg text-center text-white bg-blue-800">
                  ...
                  <div className="points-card rounded-lg text-center text-white bg-blue-900">
                  <div className="points-title text-xs uppercase py-2 px-3 font-semibold border-b-2 border-gray-100">
